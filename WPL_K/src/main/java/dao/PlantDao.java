...
public class PlantDao {
    ...
    //getPlantByGeslacht: Kristina
    private static final String GETPLANTBYGESLACHT =
            "SELECT * FROM plant WHERE geslacht LIKE ?" ;

    //getPlantByFenotype: Kristina
   /* private static final String GETPLANTBYFENOTYPE =
            "SELECT * FROM plant WHERE fenotype LIKE ?";
   */
    ...
    private PreparedStatement stmtSelectPlantByGeslacht;
   // private PreparedStatement stmtSelectPlantByFenotype;
    ...
    public PlantDao(Connection dbConnection) throws SQLException {   // PlantDao is niet actief ?
        ...
        stmtSelectPlantByGeslacht = dbConnection.prepareStatement(GETPLANTBYGESLACHT);
       // stmtSelectPlantByFenotype = dbConnection.prepareStatement(GETPLANTBYFENOTYPE);
    }
    ...
    //getPlantByGeslacht: Kristina
    public List<Plant> getPlantByGeslacht(String type) throws SQLException {
        List<Plant> PlantList = new ArrayList<>();

        stmtSelectPlantByGeslacht.setString(1, "%" + type + "%");
        ResultSet rs = stmtSelectPlantByGeslacht.executeQuery();
    ...
    //getPlantByFenotype: Kristina
    /*
    public List<Plant> getPlantByFenotype(String type) throws SQLException {
        List<Plant> PlantList = new ArrayList<>();

        stmtSelectPlantByFenotype.setString(1, "%" + type + "%");
        ResultSet rs = stmtSelectPlantByFenotype.executeQuery();
